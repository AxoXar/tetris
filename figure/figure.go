...
var MapGetFigure = map[string]Figure{
	"I": {
		Blocks: [4][2]int{{5, 0}, {5, 1}, {5, 2}, {5, 3}},
	},
	"O": {
		Blocks: [4][2]int{{5, 0}, {5, 1}, {6, 0}, {6, 1}},
	},
	"S": {
		Blocks: [4][2]int{{5, 0}, {6, 0}, {4, 1}, {5, 1}},
	},
	"J": {
		Blocks: [4][2]int{{5, 0}, {5, 1}, {5, 2}, {4, 2}},
	},
	"L": {
		Blocks: [4][2]int{{5, 0}, {5, 1}, {5, 2}, {6, 2}},
	},
	"Z": {
		Blocks: [4][2]int{{5, 0}, {6, 0}, {6, 1}, {7, 1}},
	},
	"T": {
		Blocks: [4][2]int{{4, 0}, {5, 0}, {6, 0}, {5, 1}},
	},
}
